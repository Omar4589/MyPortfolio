    ...
    >
      ...
      >
        ...
        <div className="mx-0  lg:mx-4 flex flex-col jusify-center  items-center space-y-2 xl:space-y-2 font-robotoLight leading-7 md:leading-7 lg:leading-9 xl:leading-0">
          <p className="text-base  md:text-lg  md:mx-2 leading-7 lg:text-lg  xl:text-lg ">
            ...
            <span className="font-roboto">technology</span>.
          </p>
          <p className="text-base  md:text-lg  md:mx-2 leading-7 lg:text-lg xl:text-lg">
            My love for acquiring new knowledge and my eagerness to be
            challenged are what fuel my passion for development. With a mindset
            geared towards <span className="font-roboto">problem-solving</span>{" "}
            and <span className="font-roboto">critical thinking</span>, I
            approach every project with the determination to find{" "}
          ...
          <p className="text-base  md:text-lg  md:mx-2 leading-7 lg:text-lg xl:text-lg">
            ...
            capacity to{" "}
            <span className="font-roboto">collaborate and adapt</span>. If you're seeking someone who
          ...
          <p className="text-base  md:text-lg  md:mx-2 leading-7 lg:text-lg xl:text-lg">
            ...
            community. <span className="font-roboto">Let's build something great together!</span>
          </p>
        </div>
      </div>
    </div>
