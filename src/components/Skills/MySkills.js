...
const MySkills = () => {
  ...
  return (
    <div
      id="skills-container"
      className="relative z-10  mx-14 flex flex-col justify-center space-y-12 select-none"
    >
      ...
      <div
        id="skills-icons"
        className="flex flex-col justify-center items-center space-y-12 mx-6 font-robotoM"
      >
        <div className="flex w-full justify-between">
          ...
          >
            <h2 className="text-lg underline md:text-2xl  xl:text-2xl">
              Languages
            </h2>
            <div
        ...
        <div className="flex w-full justify-between ">
          ...
          >
            <h1 className="text-lg underline md:text-2xl  xl:text-2xl">Tools</h1>
            <div
